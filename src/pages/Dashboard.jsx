    ...
    <div className="flex h-screen w-full bg-background text-white overflow-hidden font-sans">
      ...
      <aside className="w-64 bg-background border-r border-gray-800 hidden md:flex flex-col z-20">
        ...
        <nav className="flex-1 px-4 space-y-1 mt-4 overflow-y-auto">
          ...
          {/* Inventario - Activo */}
          <Link to="/dashboard" className="flex items-center gap-3 px-3 py-2.5 bg-primary text-white rounded-lg shadow-lg shadow-blue-900/40 transition-transform active:scale-95">
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {/* Usuarios */}
          <Link to="/usuarios" className="flex items-center gap-3 px-3 py-2.5 text-gray-400 hover:bg-surface hover:text-white rounded-lg transition-colors group">
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
