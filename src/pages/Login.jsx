...
export default function Login() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      // Consultar el rol directamente tras el login
      let userRole = 'user'
      try {
        const { data: profileData } = await supabase
          ...
          .maybeSingle() // Devuelve null si no hay fila, sin lanzar error
        userRole = profileData?.role ?? 'user'
      } catch (e) {
        console.warn('No se pudo leer el rol, usando "user" por defecto')
      }
